...
@section('content')
    <div class="panel  panel-danger panel-bordered">
        ...
        <form class="form-horizontal" action="/admin/agenda" method="POST" id="create_agenda">
            @csrf
        </form>
        ...
        <div class="panel-body">
            <div class="form-group">
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <input type="text" placeholder="Judul Kegiatan" name="title" value="{{old('title')}}" form="create_agenda"
