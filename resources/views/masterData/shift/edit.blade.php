...
<link href="{{asset("admin/demo/plugins/bootstrap-timepicker/bootstrap-timepicker.min.css")}}" rel="stylesheet">
<div class="boxed">
    <!--CONTENT CONTAINER-->
    <!--===================================================-->
        ...
        <div id="page-content">
            ...
            <div class="panel">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" action="/data/shift/{{$shift->id}}" method="POST">
                        @csrf
                        @method('put')
                        <div class="panel-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="input-group date">
                                            <input id="timepicker-edit-shift-masuk" type="text" class="form-control" name="start_working_time" value="{{$shift->start_working_time}}">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="input-group date">
                                            <input id="timepicker-edit-shift-keluar" type="text" class="form-control" name="end_working_time" value="{{$shift->end_working_time}}">
                                            <span class="input-group-addon"><i class="ti-timer"></i></span>
                                        </div>
                                    </div>
                                </div>
    ...
    <!--Bootstrap Timepicker [ OPTIONAL ]-->
    <script src="{{asset("admin/demo/plugins/bootstrap-timepicker/bootstrap-timepicker.min.js")}}"></script>
