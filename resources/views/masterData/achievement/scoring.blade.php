...
<div class="panel panel-bordered panel-danger">
    ...
    <div class="panel-body">
        <div class="row mar-btm">
            ...
            <div class="col-sm-4">
                <form action="{{url('/admin/achievement/scoring')}}" method="POST" id="submit-achievement">
                    @csrf
                    <div id="pickadate">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center">
                        <input type="range" class="form-range" min="0" max="100" id="customRange_{{$loop->iteration}}"
