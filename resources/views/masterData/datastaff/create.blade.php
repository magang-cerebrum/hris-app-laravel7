...
<div class="panel panel-danger panel-bordered">
    ...
    <form class="form-horizontal" action="/admin/data-staff" method="POST" id="form_create">
        @csrf
    </form>
    ...
    <div class="panel-body">
            ...
            <div class="row">
                ...
                <div class="col-sm-4">
                    <div class="radio">
                        ...
                        <input id="gender-1" class="magic-radio" type="radio" form="form_create"
                            name="gender" value="Laki-laki">
                        <label for="gender-1">Laki-laki</label>
                        <input id="gender-2" class="magic-radio" type="radio" form="form_create"
        ...
        <div class="form-group">
            <div class="row">
                ...
                <div class="col-sm-10">
                    <textarea id="textarea-input-address" rows="2" class="form-control" form="form_create"
                        placeholder="Alamat Lengkap" name="address" value="{{old('address')}}"></textarea>
                </div>
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            <div class="row">
                ...
                <div class="col-sm-4">
                    <div class="radio">
                        <!-- Inline radio buttons -->
                        <input id="employee_status_radio-1" class="magic-radio" type="radio" form="form_create"
                            name="employee_status" value="Tetap" onclick="showContractOption()">
                        <label for="employee_status_radio-1">Tetap</label>
                        <input id="employee_status_radio-2" class="magic-radio" type="radio" form="form_create"
                            name="employee_status" value="Kontrak" onclick="showContractOption()">
                        <label for="employee_status_radio-2">Kontrak</label>
                        <input id="employee_status_radio-3" class="magic-radio" type="radio" form="form_create"
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <div class="radio">
                    <!-- Inline radio buttons -->
                    <input id="status_radio-1" class="magic-radio" type="radio" name="status" value="Aktif" form="form_create">
        ...
        <div class="form-group">
            <div class="row">
                ...
                <div class="col-sm-4">
                    <select class="selectpicker" data-style="btn-mint" name="credit_card_bank" form="form_create">
