...
<div class="panel panel-primary panel-bordered">
    ...
    <div class="panel-body">
        <div class="table-responsive">
            <form action="{{ url('/staff/schedule/edit-schedule')}}" method="POST" style="display: inline" id="form-chek-user-month" class="form-horizontal">
                @csrf
                <div class="row">
                    <div class="col-sm-12">
                        <button id="btn-post" class="btn btn-primary btn-labeled add-tooltip" style="margin-bottom: 10px" type="submit" data-toggle="tooltip"
                            data-container="body" data-placement="top" data-original-title="Edit Jadwal Kerja" onclick="submit_add()">
