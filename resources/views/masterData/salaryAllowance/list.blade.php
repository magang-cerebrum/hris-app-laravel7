...
@section('content-title','Data Staff / Tunjangan Gaji')
...
@section('content')
    <div class="panel panel-danger panel-bordered">
        ...
        <div class="panel-body" style="padding-top: 20px">
                ...
                <div class="col-sm-4">
                    <div id="pickadate">
                        <div class="input-group date">
                            ...
                            <span class="input-group-btn">
                                <button class="btn btn-mint" id="btn-search" type="submit" form="search"><i class="fa fa-search"></i></button>
                            </span>
                        </div>
                    </div>
                </div>
            ...
            <div class="text-center">{{ $salaryallowance->links() }}</div>
        </div>
    </div>
@endsection
