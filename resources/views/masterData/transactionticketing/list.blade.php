                ...
                <div class="row mar-btm">
                    <div class="col-sm-8">
                        <button id="btn-onprog" class="btn btn-primary  btn-labeled add-tooltip"
                            data-toggle="tooltip" data-container="body" data-placement="top" form="form-mul-onprog"
                        ...
                        <div class="radio mar-hor" style="display: inline">
                            ...
                            <input id="lihat_selesai_radio-1" class="magic-radio toogle_selesai" type="radio" form="form-mul-onprog"
                                name="lihat_selesai" value="On">
                            <label for="lihat_selesai_radio-1">On</label>
                            <input id="lihat_selesai_radio-2" class="magic-radio toogle_selesai" type="radio" form="form-mul-onprog"
