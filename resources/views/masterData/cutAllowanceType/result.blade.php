        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="row mar-btm" style="margin-top:-60px">
                    <div class="col-sm-4">
                        <form action="{{url('/admin/cuts-allowances/search')}}" method="get"
                ...
                <div class="row mar-btm">
                    <div class="col-sm-8">
                        <a href="{{url('/admin/cuts-allowances/add')}}" class="btn btn-primary btn-labeled add-tooltip" data-toggle="tooltip" data-container="body" data-placement="top" data-original-title="Tambah Potongan Gaji Baru">
            ...
            <div class="row">
                <div class="col-sm-12 text-right">
                    <a href="{{url('/admin/cuts-allowances')}}" class="btn btn-warning btn-labeled text-center">Tampilkan Semua Tipe Potongan dan Tunjangan Gaji</a>
                </div>
            </div>
        </div>
    </div>
