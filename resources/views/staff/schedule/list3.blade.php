...
@section('head')
	...
	<link rel="stylesheet" href="{{ url('https://cdn.jsdelivr.net/npm/fullcalendar@3.9.0/dist/fullcalendar.min.css')}}" />
	<script src="{{ url('https://cdn.jsdelivr.net/npm/moment@2.27.0/moment.min.js')}}"></script>
