    ...
    <div class="panel-body">
        <div class="row">
            <div class="col-sm-12">
                <div class="row">
                    <div class="col-sm-8">
                        <form action="/admin/ticketing/on-progress" method="POST" id="form-mul-onprog" style="display: inline">
                            @csrf
                            @method('put')
                            ...
                            <div class="radio mar-hor" style="display: inline">
                                ...
                                <input id="lihat_selesai_radio-1" class="magic-radio" type="radio" name="lihat_selesai" value="On" onclick="toogle_selesai()">
                                <label for="lihat_selesai_radio-1">On</label>
                                <input id="lihat_selesai_radio-2" class="magic-radio" type="radio" name="lihat_selesai" value="Off" checked onclick="toogle_selesai()" >
                    ...
                    <div class="col-sm-3">
                        <div class="input-group mar-btm float-right">
                            <input type="text" id="cari-ticket" class="form-control" placeholder="Cari Ticket"
