...
<div class="panel  panel-danger panel-bordered">
    ...
    <form class="form-horizontal" action="/admin/agenda/{{$agenda->id}}" method="POST">
        @csrf
        @method('put')
                ...
                <div class="row">
                    ...
                    <div class="col-sm-10">
                        <textarea id="textarea-description" rows="2"
                            ...
                            value="{{old('description')}}">{{$agenda->description}}</textarea>
                        ...
                        <div class="col-sm-10">
                            <div class="input-group input-daterange">
                                <input type="text" class="form-control @error('start_date') is-invalid @enderror"
                                    ...
                                    value="{{explode(" ", $agenda->start_event)[0]}}" autocomplete="off">
                                <span class="input-group-addon">sampai</span>
                                <input type="text" class="form-control @error('end_date') is-invalid @enderror"
                                    placeholder="Tanggal Berakhir" name="end_date" id="end_date"
                                    value="{{explode(" ", $agenda->end_event)[0]}}" autocomplete="off">
                            </div>
