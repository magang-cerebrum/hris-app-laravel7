        ...
        <div class="panel-body" style="padding-top: 20px">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <input type="checkbox"
                                    class="check-item-active @error('selectid_active') is-invalid @enderror"
            ...
            <div class="row">
                <div class="col-sm-12 text-right">
                    <a href="{{url('/staff/data-staff')}}" class="btn btn-warning btn-labeled text-center">Tampilkan Semua Staff Divisi</a>
                </div>
            </div>
        </div>
    </div>
