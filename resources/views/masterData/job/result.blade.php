...
@section('content')
    <div class="panel panel-danger panel-bordered">
        <div class="panel-heading">
            <h3 class="panel-title">Hasil Pencarian Lowongan "{{$searched}}"</h3>
        </div>
            ...
            @else
                ...
                <div class="row">
                    <div class="col-sm-12 text-right">
                        <a href="{{url('/admin/job')}}" class="btn btn-warning btn-labeled text-center">Tampilkan Semua Lowongan Kerja</a>
                    </div>
                </div>
            @endif
        </div>
