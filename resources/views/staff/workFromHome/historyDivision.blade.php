...
@section('content-title','WFH Anggota Divisi / Riwayat Pengajuan WFH')
        ...
        <div class="panel-body" style="padding-top: 20px">
            <div class="row mar-btm" id="row_btn">
                <div id="btn_paid_leave">
                    <a href="{{url('/staff/wfh/division')}}" class="btn btn-dark btn-labeled add-tooltip"
                        data-toggle="tooltip" data-container="body" data-placement="top"
                        data-original-title="Kembali ke Daftar Pengajuan WFH">
            ...
            @else
                <div class="table-responsive">
                    <table id="masterdata-history-wfh"
