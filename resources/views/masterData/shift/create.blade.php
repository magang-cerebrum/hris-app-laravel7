        ...
        <div id="page-content">
            ...
            <div class="panel">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" action="/data/shift" method="POST">
                        @csrf
                        <div class="panel-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="input-group date">
                                            <input id="timepicker-input-shift-masuk" type="text" class="form-control" name="start_working_time">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="input-group date">
                                            <input id="timepicker-input-shift-keluar" type="text" class="form-control" name="end_working_time">
                                            <span class="input-group-addon"><i class="ti-timer"></i></span>
                                        </div>
                                    </div>
                                </div>
