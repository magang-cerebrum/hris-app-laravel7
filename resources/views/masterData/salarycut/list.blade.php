    ...
    <div class="panel-body">
        <div class="row">
            <div class="col-sm-12">
                <div class="row">
                    <div class="col-sm-3">
                        <a href="{{url('/admin/salary-cut/add')}}" class="btn btn-primary btn-labeled add-tooltip" style="margin-bottom:15px" data-toggle="tooltip" data-container="body" data-placement="top" data-original-title="Tambah Potongan Gaji Baru">
                    ...
                    <div class="col-sm-4">
                        <div class="form-group float-right">
                            <input type="text" id="cari-potongan" class="form-control"
                                placeholder="Cari potongan" onkeyup="search_salary_cut()">
                        </div>
                    </div>
                </div>
...
<script>
    ...
    // live search
    function search_salary_cut() {
        var input, filter, table, tr, td, i, txtValue;
        input = document.getElementById("cari-potongan");
        filter = input.value.toUpperCase();
        table = document.getElementById("masterdata-salary-cut");
