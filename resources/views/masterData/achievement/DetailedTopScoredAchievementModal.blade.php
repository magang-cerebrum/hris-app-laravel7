<div class="modal fade" id="modal-detail-top-scored-achievement" tabindex="-1" role="dialog" style="overflow-x: auto !important">
                        ...
                        @if ($monthDecideAchievement)
                            @foreach ($monthDecideAchievement as $mdaItem)
                               <tr>
                                    ...
                                    <td class="text-center">{{$mdaItem->name}}</td> 
