        ...
        <div id="page-content">
            ...
            <div class="panel">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" action="/data/staff" method="POST">
                        @csrf
                        <div class="panel-body">
                            ...
                            <input type="hidden" name="password" class="form-control invisible"
                                value="<?=password_hash("akubarukerjadisini",PASSWORD_DEFAULT)?>">
                            {{-- ================== --}}
                            <div class="form-group">
                                <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" placeholder="Sisa cuti diisi hanya dengan angka"
                                        ...
                                        class="form-control @error('yearly_leave_remaining') is-invalid @enderror" value="{{old('yearly_leave_remaining')}}">
