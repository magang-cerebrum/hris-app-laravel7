...
class CreateMasterSalaryAllowancesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('master_salary_allowances', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('master_salary_allowances');
    }
}
